...
export default function App() {
  ...
  if (phase === 'start')
    return <Overlay><HowToPlay onStart={startGame} ready={dictionary != null} /></Overlay>

  if (phase === 'over')
    return <Overlay><GameOver score={score} found={found} onPlay={startGame} /></Overlay>
    ...
    <div className="app">
      <div className="header-card">
        ...
        <div className="header-stats">
          ...
          <span className="score">SCORE: {String(score).padStart(4, '0')}</span>
        </div>
      </div>
...
function HowToPlay({ onStart, ready }) {
...
function GameOver({ score, found, onPlay }) {
  ...
  return (
    <div className="card">
      <h1>Time!</h1>
      <div className="final-score">{String(score).padStart(4, '0')}</div>
      ...
      <button className="btn-start" onClick={onPlay}>Play Again</button>
    </div>
  )
}
